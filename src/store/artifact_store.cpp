...
// SHA-256 — we don't pull in OpenSSL just for this. ~150 LoC of public-
// domain reference, kept private to this TU. Verified against NIST test
// vectors at the end of the file via a TEST_CASE in
// test_artifact_store.cpp (the empty-bytes case — sha256("") =
